 ...
 * blogId {Required}
 * id,
 * reblog_key {Required} //The reblog key for the reblogged post � get the reblog key with a /posts request	
 * comment
 * }
 */
...
Tumblr.prototype.remove = function(params, callback) {
  this._post('/blog/{blogId}/post/delete'.replace('{blogId}', params.blogId), params, callback);
  return this;
}
